			...
			(val: any) => {
				options = {
					...
					radar: {
						...
						splitNumber: 8,//置雷达图的轴线分割数量。这里的值 8 表示将雷达图的每个轴线分割成 8 个部分。
						axisLine: {//设置雷达图的轴线样式
							lineStyle: {
						...
						splitLine: {//设置雷达图的分隔线样式
							lineStyle: {
								color: colorList.linearYtoG,
								opacity: 0.6
							}
						},
						splitArea: {//设置雷达图的分隔区域样式，即轴线和分割线之间的区域样式。
							areaStyle: {
								color: "#fff",
								opacity: 0.1,
								shadowBlur: 25,//设置分隔区域的阴影模糊程度为 25。
								shadowColor: "#000",
								shadowOffsetX: 0,// 设置分隔区域的阴影在水平和垂直方向上的偏移。
								shadowOffsetY: 5 
							}
						},
						indicator: [//雷达图的维度。一个数组，包含了多个对象，每个对象表示一个指示器的名称和最大值。
							{
								name: "服务态度",
								max: val.maxData
							},
